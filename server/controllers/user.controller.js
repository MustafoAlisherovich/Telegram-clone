...
class UserController {
	...
	async getContacts(req, res, next) {
		try {
			const userId = '69712cb9de41077ec5705131'
	...
	async getMessages(req, res, next) {
		try {
			const user = '69712cb9de41077ec5705131'
	...
	async createContact(req, res, next) {
		try {
			...
			if (user.email === contact.email)
				throw new BaseError.BadRequest("You can't add yourself to contacts")
			...
			if (existingContact)
				throw new BaseError.BadRequest('This user is already in your contacts')
